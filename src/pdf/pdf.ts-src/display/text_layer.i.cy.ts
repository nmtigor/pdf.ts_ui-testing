 ...
 *
 * @module pdf/pdf.ts-src/display/text_layer.i.cy
 * @license Apache-2.0
 ******************************************************************************/
...
describe("Text layer", () => {
  describe("Text selection", () => {
    ...
    describe("using mouse", () => {
      ...
      it.skip("doesn't jump when hovering on an empty area", () => {
        // await Promise.all(
      ...
      it.skip("doesn't jump when hovering on an empty area (multi-page)", () => {
        // await Promise.all(
        //   pages.map(async ([browserName, page]) => {
    ...
    describe("using selection carets", () => {
      ...
      it.skip("doesn't jump when moving selection", () => {
  ...
  describe("when the browser enforces a minimum font size", () => {
    ...
    it.skip("renders spans with the right size", () => {
