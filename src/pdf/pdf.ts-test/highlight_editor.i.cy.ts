 ...
 *
 * @module pdf/pdf.ts-test/highlight_editor.i.cy
 * @license Apache-2.0
 ******************************************************************************/
...
describe("Highlight Editor", () => {
  describe("Editor must be removed without exception", () => {
    ...
    it.skip("must scroll and check that the draw layer is there", () => {
      // await Promise.all(
  ...
  describe("Editor must keep selected", () => {
    ...
    it.skip("must scroll and check that the highlight is selected", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("The default color must have the correct value", () => {
    ...
    it.skip("must highlight with red color", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Invisible editor must change its color", () => {
    ...
    it.skip("must scroll and change the color without exceptions", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Highlight data serialization", () => {
    ...
    it.skip("must be correctly serialized", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Color picker and keyboard", () => {
    ...
    it.skip("must check that we can use the keyboard to select a color", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Text highlights aren't draggable", () => {
    ...
    it.skip("must check that a text highlight don't move when arrows are pressed", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Color picker and click outside", () => {
    ...
    it.skip("must check that the dropdown is hidden", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
      //     const sel = getEditorSelector(0);
  ...
  describe("Color picker can annoy the user when selecting some text", () => {
    ...
    it.skip("must check that editor is unselected when the mouse is down on the text layer", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
      //     const sel = getEditorSelector(0);
  ...
  describe("Free highlight thickness can be changed", () => {
    ...
    it.skip("must check that the thickness is correctly updated", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Highlight with the keyboard", () => {
    ...
    it.skip("must check that some text has been highlighted", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
      //     const sel = getEditorSelector(0);
  ...
  describe("Free highlight is drawn at the right place after having been rotated (bug 1879108)", () => {
    ...
    it.skip("must check that highlight is at the correct position", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Highlight links", () => {
    ...
    it.skip("must check that it's possible to highlight a part of a link", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Highlight forms", () => {
    ...
    it.skip("must check that it's possible to highlight a part of a form", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Send a message when some text is selected", () => {
    ...
    it.skip("must check that a message is sent on selection", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     const rect = await getSpanRectFromText(page, 1, "Abstract");
      //     const x = rect.x + rect.width / 2;
  ...
  describe("Highlight and caret browsing", () => {
    ...
    it.skip("must check that the caret can move a highlighted text", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
    ...
    it.skip("must check that selection is correctly highlighted on arrow down key pressed", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
    ...
    it.skip("must check that an highlight can be left with the keyboard", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Editor must be removed in using the space key on the delete button", () => {
    ...
    it.skip("must check that the highlight has been deleted", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Thickness must be enabled when there's no selected highlights", () => {
    ...
    it.skip("must check the thickness input state", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Quadpoints must be correct", () => {
    ...
    it.skip("must check that the quadpoints for an highlight are almost correct", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Quadpoints must be correct when they're in a translated page", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue18360.pdf")}`);
    });
    ...
    it.skip("must check that the quadpoints for an highlight are almost correct", () => {
      ...
      //     await page.waitForSelector(getEditorSelector(0));
      //     await waitForSerialized(page, 1);
      //     const quadPoints = await getFirstSerialized(
      //       page,
      //       (e) => e.quadPoints,
      //     );
  ...
  describe("Editor must be unselected when the color picker is Escaped", () => {
    ...
    it.skip("must check that the highlight editor is unselected", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Highlight editor mustn't be moved when close to the page limits", () => {
    ...
    it.skip("must check the editor coordinates", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Show/hide all the highlights", () => {
    ...
    it.skip("must check that the highlights are correctly hidden/shown", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Highlight from floating highlight button", () => {
    ...
    it.skip("must check that clicking on the highlight floating button triggers an highlight", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     const rect = await getSpanRectFromText(page, 1, "Abstract");
      //     const x = rect.x + rect.width / 2;
  ...
  describe("Text layer must have the focus before highlights", () => {
    ...
    it.skip("must check the focus order", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Undo a highlight", () => {
    ...
    it.skip("must check that a highlight can be undone", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Use a toolbar overlapping an other highlight", () => {
    ...
    it.skip("must check that the toolbar is usable", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Draw a free highlight with the pointer hovering an existing highlight", () => {
    ...
    it.skip("must check that an existing highlight is ignored on hovering", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToHighlight(page);
  ...
  describe("Highlight with the floating button in a pdf containing a FreeText", () => {
    ...
    it.skip("must check that the highlight is created", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
