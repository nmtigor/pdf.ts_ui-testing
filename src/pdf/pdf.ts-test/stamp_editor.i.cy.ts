 ...
 *
 * @module pdf/pdf.ts-test/stamp_editor.i.cy
 * @license Apache-2.0
 ******************************************************************************/
...
describe("Stamp Editor", () => {
  describe("Basic operations", () => {
    ...
    it.skip("must load a PNG which is bigger than a page", () => {
      // await Promise.all(
  ...
  describe("Resize", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("empty.pdf", 50)}`);
    });

    it.skip("must check that an added image stay within the page", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     if (browserName === "firefox") {
      //       // Disabled in Firefox, because of https://bugzilla.mozilla.org/1553847.
  ...
  describe("Alt text dialog", () => {
    ...
    it.skip("must check that the alt-text flow is correctly implemented", () => {
  ...
  describe("Resize an image with the keyboard", () => {
    ...
    it.skip("must check that the dimensions change", () => {
      // // Run sequentially to avoid clipboard issues.
      // for (const [browserName, page] of pages) {
      //   await switchToStamp(page);
  ...
  describe("Copy/paste from a tab to an other", () => {
    ...
    it.skip("must check that the alt-text button is here when pasting in the second tab", () => {
  ...
  describe("Undo a stamp", () => {
    ...
    it.skip("must check that a stamp can be undone", () => {
      // // Run sequentially to avoid clipboard issues.
  ...
  describe("Resize a stamp", () => {
    ...
    it.skip("must check that a resized stamp has its canvas at the right position", () => {
      // // Run sequentially to avoid clipboard issues.
      // for (const [, page] of pages) {
      //   await switchToStamp(page);
  ...
  describe("Add a stamp in odd spread mode", () => {
    ...
    it.skip("must check that the stamp has its canvas at the right position", () => {
      // // Run sequentially to avoid clipboard issues.
      // for (const [, page] of pages) {
      //   await switchToStamp(page);
  ...
  describe("Copy and paste a stamp with an alt text", () => {
    ...
    it.skip("must check that the pasted image has an alt text", () => {
      // // Run sequentially to avoid clipboard issues.
      // for (const [browserName, page] of pages) {
      //   await switchToStamp(page);
