 ...
 *
 * @module pdf/pdf.ts-test/freetext_editor.i.cy
 * @license Apache-2.0
 ******************************************************************************/
...
describe("FreeText Editor", () => {
  describe("FreeText", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("aboutstacks.pdf")}`);
    });

    it.skip("must write a string in a FreeText editor", () => {
      // await Promise.all(
    ...
    it.skip("must check that a paste has been undone", () => {
      // // Run sequentially to avoid clipboard issues.
    ...
    it.skip("must check that aria-owns is correct", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must check that right click doesn't select", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     const rect = await getRect(page, ".annotationEditorLayer");
    ...
    it.skip("must check that text change can be undone/redone", () => {
      // // Run sequentially to avoid clipboard issues.
      // for (const [browserName, page] of pages) {
      //   const rect = await getRect(page, ".annotationEditorLayer");
  ...
  describe("FreeText (multiselection)", () => {
    ...
    it.skip("must select/unselect several editors and check copy, paste and delete operations", () => {
      // // Run sequentially to avoid clipboard issues.
      // for (const [browserName, page] of pages) {
      //   await switchToFreeText(page);
  ...
  describe("FreeText (bugs)", () => {
    ...
    it.skip("must serialize invisible annotations", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
      //     let currentId = 0;
  ...
  describe("issue 15789", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue15789.pdf")}`);
    ...
    it.skip("must take the media box into account", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
      //     let currentId = 0;
  ...
  describe("FreeText (update existing)", () => {
    ...
    it.skip("must update an existing annotation", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("FreeText (update existing and popups)", () => {
    ...
    it.skip("must update an existing annotation and show the right popup", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
  ...
  describe("FreeText (update existing but not empty ones)", () => {
    ...
    it.skip("must update an existing annotation but not an empty one", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("FreeText (delete existing)", () => {
    ...
    it.skip("must delete an existing annotation", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("FreeText (copy/paste existing)", () => {
    ...
    it.skip("must copy and paste an existing annotation", () => {
      // // Run sequentially to avoid clipboard issues.
      // for (const [browserName, page] of pages) {
      //   await switchToFreeText(page);
  ...
  describe("FreeText with popup", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("annotation-freetext.pdf")}`);
    });

    it.skip("must not remove an empty annotation", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must hide the popup when editing", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
  ...
  describe("FreeText rotation", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("empty.pdf")}`);
    });

    it.skip("must check that the dimensions of a rotated annotations are correct after a font size change", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.evaluate(() => {
  ...
  describe("FreeText (remove)", () => {
    ...
    it.skip("must delete invisible annotations", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
      //     let currentId = 0;
  ...
  describe("FreeText (open existing)", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue16633.pdf")}`);
    });
  ...
  describe("FreeText (open existing and rotated)", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("rotated_freetexts.pdf", 100)}`);
    });
  ...
  describe("Keyboard shortcuts when the editor layer isn't focused", () => {
    ...
    it.skip("must check that the shortcuts are working correctly", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Move editor with arrows", () => {
    ...
    it.skip("must check the position of moved editor", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
    ...
    it.skip("must check arrow doesn't move an editor when a slider is focused", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await selectAll(page);
    ...
    it.skip("must check the position of an empty freetext", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await clearAll(page);
  ...
  describe("Focus must go on the current page", () => {
    ...
    it.skip("must check that the focus is on the right page", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Move several FreeTexts", () => {
    ...
    it.skip("must move several annotations", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Don't unselect all when scrolling", () => {
    ...
    it.skip("must check that selected editor stay selected", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("FreeText on several pages", () => {
    ...
    it.skip("must check that first annotation is selected without errors", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Deleted FreeText", () => {
    ...
    it.skip("must check that a deleted freetext can be restored", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("FreeText accessibility", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1823296.pdf")}`);
    });

    it.skip("must check that the parent structTree id is correct", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Bug 1854818: mouse events in a selected FreeText editor", () => {
    ...
    it.skip("must check the text can be selected with the mouse", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Create editor with keyboard", () => {
    ...
    it.skip("must create an editor from the toolbar", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must create an editor with keyboard", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.keyboard.press("Enter");
  ...
  describe("Avoid to steal keyboard events", () => {
    ...
    it.skip("must check the keyboard event is limited to the input", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Delete a freetext in using the delete button", () => {
    ...
    it.skip("must check that a freetext is deleted", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Delete two freetexts in using the delete button and the keyboard", () => {
    ...
    it.skip("must check that freetexts are deleted", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Consecutive white spaces in Freetext without appearance", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1871353.pdf")}`);
    });

    it.skip("must check that consecutive white spaces are preserved when a freetext is edited", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
      //     await page.click(getEditorSelector(0), { count: 2 });
  ...
  describe("Consecutive white spaces in Freetext with appearance", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1871353.1.pdf")}`);
    });
  ...
  describe("Freetext with several lines", () => {
    ...
    it.skip("must check that all lines are correctly exported", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Freetext UI when undoing/redoing", () => {
    ...
    it.skip("must check that the parameters are updated when undoing/redoing", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Annotation editor layer visibility", () => {
    ...
    it.skip("must check that the annotation layer is visible after a rotation", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Delete a freetext and undo it on another page", () => {
    ...
    it.skip("must check that a freetext can be undone", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
  ...
  describe("Paste some html", () => {
    ...
    it.skip("must check that pasting html just keep the text", () => {
      // // Run sequentially to avoid clipboard issues.
      // for (const [browserName, page] of pages) {
      //   await switchToFreeText(page);
  ...
  describe("Update a freetext and scroll", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("tracemonkey_freetext.pdf")}`);
    });

    it.skip("must check that a freetext is still there after having updated it and scroll the doc", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await switchToFreeText(page);
