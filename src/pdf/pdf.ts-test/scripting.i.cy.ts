 ...
 *
 * @module pdf/pdf.ts-test/scripting.i.cy
 * @license Apache-2.0
 ******************************************************************************/
...
describe("Interaction", () => {
  ...
  describe("in 160F-2019.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("160F-2019.pdf")}`);
    });

    it.skip("must check that first text field has focus", () => {
      // await Promise.all(
    ...
    it.skip("must show a text field and then make in invisible when content is removed", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must format the field with 2 digits and leave field with a click", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.type(getSelector("416R"), "3.14159", { delay: 200 });
      //     await page.click(getSelector("419R"));
    ...
    it.skip("must format the field with 2 digits, leave field with a click and again", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must format the field with 2 digits and leave field with a TAB", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must format the field with 2 digits and hit ESC", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must format the field with 2 digits on key ENTER", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     const prevSum = await page.$eval(getSelector("427R"), el => el.value);
  ...
  describe("in js-buttons.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("js-buttons.pdf")}`);
    });

    it.skip("must show values in a text input when clicking on radio buttons", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
    ...
    it.skip("must show values in a text input when clicking on checkboxes", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     const expected = [
      //       ["85R", "Check1=Yes::5"],
    ...
    it.skip("must show values in a text input when clicking on checkboxes in a group", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     const expected = [
      //       ["90R", "Check5=Yes1::9"],
    ...
    it.skip("must show values in a text input when clicking on checkboxes or radio with no actions", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     const expected = [
      //       ["", "Off;Off"],
  ...
  describe("in doc_actions.pdf for printing", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("doc_actions.pdf")}`);
    });

    it.skip("must execute WillPrint and DidPrint actions", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
  ...
  describe("in doc_actions.pdf for saving", () => {
    ...
    it.skip("must execute WillSave and DidSave actions", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in doc_actions.pdf for page actions", () => {
    ...
    it.skip("must execute PageOpen and PageClose actions", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in js-authors.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("js-authors.pdf")}`);
    });

    it.skip("must print authors in a text field", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
  ...
  describe("in listbox_actions.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("listbox_actions.pdf")}`);
    });

    it.skip("must print selected value in a text field", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must clear and restore list elements", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
    ...
    it.skip("must insert new elements", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     let len = 6;
    ...
    it.skip("must delete some element", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     let len = 6;
      //     // Click on Restore button.
  ...
  describe("in js-colors.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("js-colors.pdf")}`);
    });

    it.skip("must change colors", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
  ...
  describe("in issue13132.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue13132.pdf")}`);
    });

    it.skip("must compute sum of fields", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("Check field properties", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("evaljs.pdf")}`);
    });

    it.skip("must check page index", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in issue13269.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue13269.pdf")}`);
    });

    it.skip("must update fields with the same name from JS", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in secHandler.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("secHandler.pdf")}`);
    });

    it.skip("must print securityHandler value in a text field", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     const text = await actAndWaitForInput(
      //       page,
  ...
  describe("in issue14307.pdf (1)", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue14307.pdf")}`);
    ...
    it.skip("must check input for US zip format", () => {
  ...
  describe("in issue14307.pdf (2)", () => {
    ...
    it.skip("must check input for US phone number (long) format", () => {
      // // Run the tests sequentially to avoid any focus issues between the two
      // // browsers when an alert is displayed.
      // for (const [browserName, page] of pages) {
      //   await page.waitForFunction(
  ...
  describe("in issue14307.pdf (3)", () => {
    ...
    it.skip("must check input for US phone number (short) format", () => {
      // // Run the tests sequentially to avoid any focus issues between the two
      // // browsers when an alert is displayed.
      // for (const [browserName, page] of pages) {
      //   await page.waitForFunction(
  ...
  describe("in issue14862.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue14862.pdf")}`);
      // pages.map(async ([, page]) => {
      //   page.on("dialog", async (dialog) => {
      //     await dialog.dismiss();
      //   });
    ...
    it.skip("must convert input to uppercase", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
    ...
    it.skip("must check that an infinite loop is not triggered", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in issue14705.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue14705.pdf")}`);
      // pages.map(async ([, page]) => {
      //   page.on("dialog", async (dialog) => {
      //     await dialog.dismiss();
      //   });
    ...
    it.skip("must check that field value is correctly updated", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in bug1766987.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1766987.pdf")}`);
    });

    it.skip("must check that field value is correctly formatted", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in issue15053.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue15053.pdf")}`);
    });

    it.skip("must check that a button and text field with a border are hidden", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in bug1675139.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1675139.pdf")}`);
    });

    it.skip("must check that data-main-rotation is correct", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in issue15092.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue15092.pdf")}`);
    });

    it.skip("must check that a values is correctly updated on a field and its siblings", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in bug1782564.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1782564.pdf")}`);
    });

    it.skip("must check that charLimit is correctly set", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in bug1802888.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1802888.pdf")}`);
    });

    it.skip("must check field value is treated by default as a number", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in issue15753.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue15753.pdf")}`);
    });

    it.skip("must check field value is correctly updated when committed with ENTER key", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in issue15815.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue15815.pdf")}`);
    });
  ...
  describe("in issue15818.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue15818.pdf")}`);
    });

    it.skip("must check the field value set when the document is open", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
    ...
    it.skip("must check the format action is called when setFocus is used", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in autoprint.pdf", () => {
    ...
    it.skip("must check if printing is triggered when the document is open", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
  ...
  describe("in bug1811694.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1811694.pdf")}`);
    });

    it.skip("must check that a field value with a number isn't changed", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in bug1811510.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1811510.pdf")}`);
    });

    it.skip("must check that a field value with a number with a comma has the correct value", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in issue16067.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue16067.pdf")}`);
    });

    it.skip("must check that a field has the correct value when a choice is changed", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in bug1825002.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1825002.pdf")}`);
    });

    it.skip("must check that a field has the correct formatted value", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
    ...
    it.skip("must check that a field is empty", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in bug1844576.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("bug1844576.pdf")}`);
    });
  ...
  describe("in annotation_hidden_noview.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("annotation_hidden_noview.pdf")}`);
    });

    it.skip("must check that invisible fields are made visible", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("in issue16863.pdf", () => {
    before(() => {
      cy.visit(`/${P_html}?${queriesFrom("issue16863.pdf")}`);
    });

    it.skip("must check that checkboxes are correctly resetted", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page]) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("Textfields and focus", () => {
    ...
    it.skip("must check that focus/blur callbacks aren't called", () => {
      // await Promise.all(
  ...
  describe("Textfield with a Blur callback", () => {
    ...
    before(() => {
      ...
      //   ),
      // );
      cy.visit(`/${P_html}?${queriesFrom("bug1863910.pdf")}`);
    });
    ...
    it.skip("must check that blur callback is called", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page], i) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("Radio button without T value", () => {
    ...
    before(() => {
      ...
      //   ),
      // );
      cy.visit(`/${P_html}?${queriesFrom("bug1860602.pdf")}`);
    });
    ...
    it.skip("must check that only one radio is selected", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page], i) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("Textfield with a number and some decimals", () => {
    ...
    before(() => {
      ...
      //   ),
      // );
      cy.visit(`/${P_html}?${queriesFrom("issue17540.pdf")}`);
    });
    ...
    it.skip("must check the number has the correct number of decimals", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page], i) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("Textfield with a zip code starting with 0", () => {
    ...
    before(() => {
      ...
      //   ),
      // );
      cy.visit(`/${P_html}?${queriesFrom("bug1889122.pdf")}`);
    });
    ...
    it.skip("must check the zip code is correctly formatted", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page], i) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("Value of event.change when a choice list is modified", () => {
    ...
    before(() => {
      ...
      //   ),
      // );
      cy.visit(`/${P_html}?${queriesFrom("issue17998.pdf")}`);
    });
    ...
    it.skip("must check the properties of the event", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page], i) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
  ...
  describe("PageOpen and PageClose actions in fields", () => {
    ...
    before(() => {
      ...
      //   ),
      // );
      cy.visit(`/${P_html}?${queriesFrom("issue18305.pdf")}`);
    });
    ...
    it.skip("must check that PageOpen/PageClose actions are correctly executed", () => {
      // await Promise.all(
      //   pages.map(async ([browserName, page], i) => {
      //     await page.waitForFunction(
      //       "window.PDFViewerApplication.scriptingReady === true"
